...
*/
  ...
  class_<Micropolis>("Micropolis")
    ...
    .function("getPopulationDensityMapAddress", &Micropolis::getPopulationDensityMapAddress)
    .function("getTrafficDensityMapAddress", &Micropolis::getTrafficDensityMapAddress)
    .function("getPollutionDensityMapAddress", &Micropolis::getPollutionDensityMapAddress)
    .function("getLandValueMapAddress", &Micropolis::getLandValueMapAddress)
    .function("getCrimeRateMapAddress", &Micropolis::getCrimeRateMapAddress)
    .function("getRateOfGrowthMapAddress", &Micropolis::getRateOfGrowthMapAddress)
    .function("getPowerGridMapAddress", &Micropolis::getPowerGridMapAddress)
    ...
    .property("roadPercent", &Micropolis::roadPercent)
    .property("policePercent", &Micropolis::policePercent)
    .property("firePercent", &Micropolis::firePercent)
    .property("roadFund", &Micropolis::roadFund)
    .property("policeFund", &Micropolis::policeFund)
    .property("fireFund", &Micropolis::fireFund)
    .property("trafficAverage", &Micropolis::trafficAverage)
    .property("pollutionAverage", &Micropolis::pollutionAverage)
    .property("crimeAverage", &Micropolis::crimeAverage)
    ...
    .function("getHistory", &Micropolis::getHistory)
